...
const StoryList: React.FC<StoryListProps> = ({ stories, selectedStory, onSelectStory, isPlaying }) => {
  return (
    <aside className="w-full lg:w-[400px] flex flex-col border-r border-[#cfe7d7] dark:border-gray-800 bg-white/30 dark:bg-black/10 shrink-0 overflow-hidden">
      <div className="p-6 pb-2">
        <h2 className="text-xl font-bold mb-4">Kho tàng truyện cổ tích</h2>
        <div className="relative w-full">
          <input 
            className="w-full h-12 pl-12 pr-4 rounded-xl bg-white dark:bg-gray-800 border-none ring-1 ring-gray-200 dark:ring-gray-700 focus:ring-2 focus:ring-primary focus:outline-none placeholder:text-gray-400 text-sm shadow-sm transition-all" 
